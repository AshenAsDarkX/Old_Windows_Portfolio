  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] border-2 border-b-gray-500 border-l-white border-r-gray-500 border-t-white bg-windows-neutral focus:outline-none">
            ...
            <Dialog.Close asChild>
              <button className="" aria-label="Close">
                <div className="closeButtonHover items-center justify-center border-2 border-solid border-black ">
                  <div className="border-2 border-b-gray-500 border-l-white border-r-gray-500 border-t-white bg-windows-neutral">
